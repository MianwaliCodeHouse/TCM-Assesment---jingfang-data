<script>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      ...
      {{-- <input class="form-control" id="threshold" type="text" name="field-name" placeholder="Enter Threshold"> --}}
    <textarea name="field-name" id="threshold" cols="30" rows="10" class="form-control"></textarea></div>
  ...
  <section class="py-8"><div class="container">
    <div class="px-4 pb-4 mb-6 bg-white rounded shadow">
      <div class="table-responsive">
        <table class="table mb-0 table-borderless table-striped small"><thead><tr class="text-secondary"><th class="pt-4 pb-3 px-6">Name</th><th class="pt-4 pb-3 px-6">Note</th><th class="pt-4 pb-3 px-6">Action</th></tr></thead><tbody id="tb">
          @foreach($groups as $g)
          <tr id="row{{$g->id}}">
          <td class="py-5 px-6" id="name{{$g->id}}">{{$g->name}}</td>
          <td class="py-5 px-6" id="threshold{{$g->id}}">{{$g->notes}}</td>
