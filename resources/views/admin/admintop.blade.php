              ...
              <div>
                <h3 class="mb-2 text-secondary text-uppercase small">Main</h3>
                 <ul class="navbar-nav">
                  ...
                  <li id="notes" class="nav-item nav-pills">
                    <a class="nav-link text-secondary p-3 d-flex align-items-center" href="notes">
                      <span id="notes_a">Category Notes </span>
                    </a>
                  </li>
                  <li id="invites" class="nav-item nav-pills">
                    <a class="nav-link text-secondary p-3 d-flex align-items-center" href="invites">
                      <span id="invites_a">Clinicians</span>
                    </a>
                  </li>
                  <li id="clinicanInfo" class="nav-item nav-pills">
                    <a class="nav-link text-secondary p-3 d-flex align-items-center" href="clinicanInfo">
                      <span id="clinicanInfo_a">Clinicians Info</span>
                    </a>
                  </li>
