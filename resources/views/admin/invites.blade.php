...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    ...
    <div class="mb-6">
      ...
      <input class="form-control" id="practice_address" type="text" name="field-name" placeholder="Enter Last Name"></div>
      <div class="mb-6">
        <label class="form-label" for="">Mailing Address</label>
        <input class="form-control" id="mailing_address" type="text" name="field-name" placeholder="Enter Last Name"></div>
      <div class="mb-6">
        <label class="form-label" for="">Phone Number</label>
        <input class="form-control" id="phone_number" type="number" name="field-name" placeholder="Enter Last Name"></div>
        <div class="mb-6">
        <label class="form-label" for="">Licence Number</label>
        <input class="form-control" id="licence_number" type="number" name="field-name" placeholder="Enter Last Name"></div>
        <div class="mb-6">
        <label class="form-label" for="">Country Licence Issued</label>
        <input class="form-control" id="country_licence_issued" type="text" name="field-name" placeholder="Enter Last Name"></div>
    <div class="mb-6">
...
$("#actionnew").click(function(){
  ...
  practice_address=$("#practice_address").val()
  mailing_address=$("#mailing_address").val()
  phone_number=$("#phone_number").val()
  licence_number=$("#licence_number").val()
  country_licence_issued=$("#country_licence_issued").val()
  status=$("#status").val()
  ...
  if(action=="Invite")
  {
  add(firstname,lastname,emailaddress,status,practice_address,mailing_address,phone_number,licence_number,country_licence_issued)
  }
...
function add(firstname,lastname,emailaddress,status,practice_address,mailing_address,phone_number,licence_number,country_licence_issued)
{
  $.ajaxSetup({
    headers: {
  ...
  $.ajax({
     type:'post',
     url:'addInvite',
     data: {firstname:firstname,lastname:lastname,emailaddress:emailaddress,status:status,practice_address:practice_address,mailing_address:mailing_address,phone_number:phone_number,licence_number:licence_number,country_licence_issued:country_licence_issued},
