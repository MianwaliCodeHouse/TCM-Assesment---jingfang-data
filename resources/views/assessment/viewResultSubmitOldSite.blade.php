      ...
      <fieldset class="border rounded-3 p-3">
        ...
        <div class="px-4 pb-4 mb-6 bg-white rounded shadow">
          <div class="table-responsive">
            <table class="table mb-0 table-borderless table-striped small"><thead><tr class="text-secondary"><th class="pt-4 pb-3 px-6">Family</th>
              <th class="pt-4 pb-3 px-6">Score</th>
              @if($maingroups[0]=="CCMQ" || $maingroups[0]=="CCMQ-SF" || $maingroups[0]=="BCQs" || $maingroups[0]=="BCQ_Negative" || $maingroups[0]=="BCQ_Positive")
              @else
...
@if($maingroups[$i]=="CCMQ" || $maingroups[$i]=="CCMQ-SF" || $maingroups[$i]=="BCQs" || $maingroups[$i]=="BCQ_Negative" || $maingroups[$i]=="BCQ_Positive")
              <td class="py-5 px-6">{{count($maingroupsansweredcorrect[$i])}}/{{$maingroupstotalquestions[$i]}} - {{number_format((float)count($maingroupsansweredcorrect[$i])/$maingroupstotalquestions[$i]*100, 2, '.', '')}}%</td>
