...
class AdminModel extends Model
{
    ...
    public function editNote($id,$name,$threshold)
    {
    $result=  DB::select(DB::raw("update maingroup set name='$name',notes='$threshold' where id=$id"));
    }
    ...
    {
    $result=  DB::select(DB::raw("update maingroup set notes='' where id=$id"));
    }
    ...
    public function addInvite($first,$last,$email,$code,$status,$practice_address,$mailing_address,$phone_number,$licence_number,$country_licence_issued)
    {
    $result=  DB::select(DB::raw("insert into clinicans(firstname,lastname,email,password,status,practice_address,mailing_address,phone_number,licence_number,country_licence_issued) values('$first','$last','$email','$code','$status','$practice_address','$mailing_address',$phone_number,$licence_number,'$country_licence_issued')"));
    return $result;
    }
