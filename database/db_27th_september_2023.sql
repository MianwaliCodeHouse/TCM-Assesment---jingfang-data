...
(96,'abc','abc','abc0098765@yopmail.com'),
(97,'dev','dev','devtest009@yopmail.com'),
(98,'demo','demo','demo00987654321@yopmail.com'),
(99,'dmmm','dmmm','dmmm@yopmail.com'),
(100,'demo','demo','demo12313123'),
(101,'der','der','der123wer@yopmail.com'),
(102,'der','der','der123wer@yopmail.com');
...
CREATE TABLE `clinicans` (
  ...
  `practice_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mailing_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_number` int DEFAULT NULL,
  `licence_number` int DEFAULT NULL,
  `country_licence_issued` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `credentials` (
  ...
  `accounttype` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL
...
(1,'Hi, %UserFirstName%  %UserLastName%  , You have been invited to take a %TestName%  assessment by your practitioner,\nKindly, Visit: %TestLink%',0,NULL,'2023-09-18 09:27:33'),
(2,'Hi, {{UserFirstName}}  {{UserLastName}}  , You have been invited to take a Herbal Consultant assessment by your practitioner,\r\nKindly, Visit: {{link}}',1,'2023-09-18 09:24:19','2023-09-18 09:24:19');
...
CREATE TABLE `invitations` (
  ...
  `attempt` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stage` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `maingroup_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(157,96,11539784,'n','Not attempted',NULL,1,'2023-09-27',1,NULL,NULL,NULL,NULL,1),
(158,97,65104953,'y','Closed','2023-09-27',1,'2023-09-27',1,NULL,NULL,NULL,NULL,1),
(159,98,42995276,'n','Not attempted',NULL,1,'2023-09-27',1,NULL,NULL,NULL,NULL,1),
(160,99,91801581,'y','1st phase',NULL,1,'2023-09-27',1,NULL,NULL,NULL,NULL,1),
(161,101,68243283,'n','Not attempted',NULL,1,'2023-09-27',1,NULL,NULL,NULL,NULL,19),
(162,102,44138954,'n','Not attempted',NULL,1,'2023-09-27',1,NULL,NULL,NULL,NULL,19);
...
insert  into `maingroup`(`id`,`parent_id`,`name`,`threshold`,`type`,`notes`) values 
(1,0,'Jingfang',0,'boolean',''),
(8,1,'GuiZhi',5,'boolean',''),
(9,1,'MaHuang',1,'boolean',NULL),
(10,1,'ChaiHu',4,'boolean',NULL),
(11,1,'DaHuang',2,'boolean',NULL),
(12,1,'HuangQi',4,'boolean',NULL),
(13,1,'ShiGao',2,'boolean',NULL),
(14,1,'HuangLian',5,'boolean',NULL),
(15,1,'GanJiang',4,'boolean',NULL),
(16,1,'ZhiFuZi',4,'boolean',NULL),
(17,1,'BanXia',3,'boolean',NULL),
(18,0,'CCMQ',5,'range',NULL),
(19,0,'CCMQ-SF',5,'range',''),
(20,0,'BCQ_Negative',5,'range',NULL),
(21,0,'BCQ_Positive',5,'range',NULL),
(22,0,'BCQs',5,'range',NULL);
...
CREATE TABLE `questions` (
  ...
  `questionoption1` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `questionoption2` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `questionoption5` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `questionoption4` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `questionoption3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `answer` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `explainertext` text COLLATE utf8mb4_unicode_ci,
  `clinicaltext` text COLLATE utf8mb4_unicode_ci,
  `maingroupid` int NOT NULL,
  `subgroupid` int DEFAULT NULL,
  `reservevalue` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
