...
(83, 'Palmer', 'Justice', 'xxxxxxxxxxxxxtest@yopmail.com'),
(84, 'mianwali', 'mianwali', 'xxxxxxxxxxxxxtest@yopmail.com'),
(85, 'Caesar', 'Clayton', 'xxxxxxxxxxxxxtest@yopmail.com'),
(86, 'yasir', 'text', 'test786yasir@yopmail.com'),
(87, '1122', 'help test', 'xxxxxxxxxxxxxtest@yopmail.com'),
(88, 'Xena', 'Branch', 'xxxxxxxxxxxxxtest@yopmail.com'),
(89, 'April', 'Gaines', 'xxxxxxxxxxxxxtest@yopmail.com'),
(90, 'Daryl', 'Durham', 'xxxxxxxxxxxxxtest@yopmail.com'),
(91, 'Rina', 'Sharp', 'xxxxxxxxxxxxxtest@yopmail.com'),
(92, 'Chastity', 'Kane', 'xxxxxxxxxxxxxtest@yopmail.com'),
(93, 'yes', 'this is test', 'mch786test@yopmail.com'),
(94, 'new', 'test again 1', 'mch786test@yopmail.com'),
(95, 'Carlos', 'Sparks', 'mch786test@yopmail.com');
...
(10, 'yasir', 'hussain', 'xxxxxxxxxxxxxtest@yopmail.com', 'AoRwXmmhAI', 'e', 'mianwali', 'mianwali', 3041121, 3041121, 'Pakistan'),
(11, 'Keely', 'Mccullough', 'mch786test@yopmail.com', 'CE9YNlkuFE', 'e', 'Autumn Simpson', 'Donna Cabrera', 73900, 7600, 'Hermione Hunt');
...
(1, 'Hi, %UserFirstName%  %UserLastName%  , You have been invited to take a %TestName%  assessment by your practitioner,\nKindly, Visit: %TestLink%', 0, NULL, '2023-09-18 04:27:33'),
(2, 'Hi, {{UserFirstName}}  {{UserLastName}}  , You have been invited to take a {{TestName}}  assessment by your practitioner,\r\nKindly, Visit: {{link}}', 1, '2023-09-18 04:24:19', '2023-09-18 04:24:19');
...
(137, 68, 441983, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 19),
(138, 83, 4625931, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 8),
(139, 83, 4625931, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 9),
(140, 84, 90168713, 'y', 'Closed', '2023-09-20', 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 18),
(141, 84, 90168713, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 19),
(142, 84, 90168713, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 20),
(143, 84, 90168713, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 21),
(144, 84, 90168713, 'n', 'Not attempted', NULL, 1, '2023-09-20', 1, NULL, NULL, NULL, NULL, 22),
(145, 85, 93307774, 'y', 'Closed', '2023-09-20', 140, '2023-09-20', 1, NULL, NULL, NULL, NULL, 18),
(146, 85, 47138, 'y', 'Closed', '2023-09-20', 140, '2023-09-20', 1, NULL, NULL, NULL, NULL, 19),
(147, 86, 26394709, 'y', 'Closed', '2023-09-20', 1, '2023-09-20', 0, NULL, NULL, NULL, NULL, 18),
(148, 86, 61302733, 'y', 'Closed', '2023-09-20', 1, '2023-09-20', 0, NULL, NULL, NULL, NULL, 19),
(149, 87, 73013204, 'n', 'Not attempted', NULL, 1, '2023-09-21', 0, NULL, NULL, NULL, NULL, 18),
(150, 87, 39179928, 'n', 'Not attempted', NULL, 1, '2023-09-21', 0, NULL, NULL, NULL, NULL, 19),
(151, 90, 55677526, 'y', 'Closed', '2023-09-21', 1, '2023-09-21', 0, NULL, NULL, NULL, NULL, 22),
(152, 91, 37246485, 'n', 'Not attempted', NULL, 1, '2023-09-21', 1, NULL, NULL, NULL, NULL, 11),
(153, 92, 98877133, 'y', 'Closed', '2023-09-21', 1, '2023-09-21', 1, NULL, NULL, NULL, NULL, 16),
(154, 93, 53736667, 'n', 'Not attempted', NULL, 1, '2023-09-22', 0, NULL, NULL, NULL, NULL, 18),
(155, 94, 30429946, 'y', 'Closed', '2023-09-26', 1, '2023-09-22', 1, NULL, NULL, NULL, NULL, 18),
(156, 95, 26566025, 'n', 'Not attempted', NULL, 1, '2023-09-26', 0, NULL, NULL, NULL, NULL, 8);
...
(8, 'GuiZhi', 5, 'boolean', ''),
(9, 'MaHuang', 1, 'boolean', NULL),
(10, 'ChaiHu', 4, 'boolean', NULL),
(11, 'DaHuang', 2, 'boolean', NULL),
...
--
ALTER TABLE `results`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5454;
