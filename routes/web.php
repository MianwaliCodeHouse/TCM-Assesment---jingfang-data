...
Route::group(["middleware"=>"admincontrol"],function(){
  ...
  Route::post('/editNotes',[Admin::class,'editNotes']);
  Route::post('/deleteGroup',[Admin::class,'deleteGroup']);
  Route::post('/deleteNote',[Admin::class,'deleteNote']);
  ...
  Route::get('/notes',[Admin::class,'notes']);
  ...
  Route::get('/clinicanInfo',[Admin::class,'clinicanInfo']);
  Route::post('/updateClinicianInfo',[Admin::class,'updateClinicianInfo'])->name('updateClinicianInfo');
});
...
Route::get('/settings',[Assessment::class,'settings'])->name('settings');
Route::post('/updateEmailTemplate',[Assessment::class,'updateEmailTemplate'])->name('updateEmailTemplate');
Route::post('/updateProfile',[Assessment::class,'updateProfile'])->name("updateProfile.info");
...
Route::get('/view/Assesment/Result',[GraphsController::class,'viewAssessmentResult'])->name('assessment.graphs');
});
